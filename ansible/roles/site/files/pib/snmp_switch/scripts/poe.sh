...
/srv/www/pib/venv/bin/python3 /srv/www/pib/venv/lib/python3.13/site-packages/snmp_switch/utils.py $port

# maybe set new value
if [ $# -eq 2 ]; then
    val=$2
    /srv/www/pib/venv/bin/python3 /srv/www/pib/venv/lib/python3.13/site-packages/snmp_switch/utils.py $port $val
fi
