...
switch:
    ...
    # pi things
    nos:
    - { port:  2, mac: "b8:27:eb:2f:5d:08", sn: 042f5d08, loc: "front 1", cable_color: "grey" }
    - { port:  3, mac: "dc:a6:32:05:32:45", sn: f1b7bb5a, loc: "front 2", cable_color: "white"}
    ...
    - { port: 11, mac: "b8:27:eb:51:01:df", sn: 265101df, loc: "front 7", cable_color: "white" }
    - { port: 13, mac: "b8:27:eb:68:fc:e7", sn: f168fce7, loc: "front 8", cable_color: "white" }
